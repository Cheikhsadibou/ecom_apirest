...
class StreamPlatformTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.stream = models.StreamPlatform.objects.create(name="Disney +",about="Disney + is a channelle streaming movies",website="https://www.hotstar.com")

    def test_streamplateform_create(self):
        data = {
            "name": "Disney +",
            "about": "Disney + is a channelle streaming movies",
    ...
    def test_streamplateform_detail(self):
        response = self.client.get(reverse('streamplatform-detail', args={self.stream.id,}))
        # response = self.client.get(reverse('streamplatform-detail', kwargs={'pk': self.stream.pk}))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
class WatchListTestCase(APITestCase):
    def setUp(self):
        ...
        self.stream = models.StreamPlatform.objects.create(name="Disney +",
                                                           about="Disney + is a channelle streaming movies",
                                                           website="https://www.hotstar.com"
                                                           )
        self.watchlist = models.WatchList.objects.create(plateform=self.stream,
    ...
    def test_watchlist_create(self):
        data = {
            ...
            "title": "Top Movies",
            "storyline": "Watchlist is a list of movies you have watched",
            "active": True
        }
...
class ReviewTestCase(APITestCase):
    def setUp(self):
        ...
        self.watchlist2 = models.WatchList.objects.create(plateform=self.stream,
                                                           title="Example movies",
                                                           storyline="Example Movie",
                                                           active=True)
    ...
    def test_review_user(self):
        ...
        self.asserEqual(response.status_code, status.HTTP_204_NO_CONTENT)
